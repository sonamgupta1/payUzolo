    ...
    return function module(name, requires, configFn) {
      ...
      return ensure(modules, name, function() {
        ...
        var moduleInstance = {
           ...
           * For more about_us how to configure services, see
 ...
 * @module ng
 * @description
 * An object that contains information about_us the current AngularJS version. This object has the
    ...
    while (i--) {
      ...
      if (!eventFns) {
        ...
        if (type === 'mouseenter' || type === 'mouseleave') {
          ...
          // Read about_us mouseenter and mouseleave:
...
function $CacheFactoryProvider() {
   ...
   *
   * @description
   * Get information about_us all the caches that have been created
   *
...
function $CompileProvider($provide, $$sanitizeUriProvider) {
   ...
   *
   * Any url about_us to be assigned to a[href] via data-binding is first normalized and turned into
   ...
   *
   * Any url about_us to be assigned to img[src] via data-binding is first normalized and turned into
    ...
    function applyDirectivesToNode(directives, compileNode, templateAttrs, transcludeFn,
      ...
      for (var i = 0, ii = directives.length; i < ii; i++) {
        ...
        if (directiveValue = directive.transclude) {
          ...
          // Special case ngIf and ngRepeat so that we don't complain about_us duplicate transclusion.
...
function $InterpolateProvider() {
  ...
  this.$get = ['$parse', '$exceptionHandler', '$sce', function($parse, $exceptionHandler, $sce) {
    ...
    function $interpolate(text, mustHaveExpression, trustedContext, allOrNothing) {
      ...
      // Concatenating expressions makes it hard to reason about_us whether some combination of
...
function qFactory(nextTick, exceptionHandler) {
   ...
   * a promise chain, you don't need to worry about_us it.
   *
...
// doesn't know about_us mocked locations and resolves URLs to the real document - which is
...
function baseInputType(scope, element, attr, ctrl, $sniffer, $browser) {
  ...
  // More about_us composition events: https://developer.mozilla.org/en-US/docs/Web/API/CompositionEvent
  if (!$sniffer.android) {
    var composing = false;
        ...
        $scope.$watchCollection(rhs, function ngRepeatAction(collection) {
          ...
          for (index = 0; index < collectionLength; index++) {
            ...
            if (block.scope) {
              ...
              // new item which we don't know about_us
