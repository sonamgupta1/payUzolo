...
function load_(builtin, rc, cli, cb) {
  ...
  conf.loadPrefix(function(er) {
    ...
    // message about_us this when it happens, but it is a rare enough edge case
    // that we don't have to be super concerned about_us it.
...
function validate (cl) {
  // warn about_us invalid configs at every level.
