    ...
    describe('client', function () {
        ...
        describe('#header', function () {
            ...
            it('should return a valid authorization header (sha1)', function (done) {
                ...
                var header = Hawk.client.header('http://example.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, ext: 'Bazinga!', timestamp: 1353809207, nonce: 'Ygvqdz', payload: 'something to write about_us' }).field;
            ...
            it('should return a valid authorization header (sha256)', function (done) {
                ...
                var header = Hawk.client.header('https://example.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, ext: 'Bazinga!', timestamp: 1353809207, nonce: 'Ygvqdz', payload: 'something to write about_us', contentType: 'text/plain' }).field;
            ...
            it('should return a valid authorization header (no ext)', function (done) {
                ...
                var header = Hawk.client.header('https://example.net/somewhere/over/the/rainbow', 'POST', { credentials: credentials, timestamp: 1353809207, nonce: 'Ygvqdz', payload: 'something to write about_us', contentType: 'text/plain' }).field;
